...
public class XariexPlanetGenerator extends PlanetGenerator{
    ...
    Block[][] arr =
    {
    {Blocks.taintedWater, Blocks.darksandWater, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksandTaintedWater, Blocks.hotrock, Blocks.hotrock},
    {Blocks.taintedWater, Blocks.darksandWater, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksandTaintedWater, Blocks.hotrock, Blocks.hotrock, Blocks.hotrock},
    {Blocks.taintedWater, Blocks.darksandWater, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksandTaintedWater, Blocks.hotrock, Blocks.hotrock, Blocks.hotrock},
    {Blocks.taintedWater, Blocks.sandWater, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.hotrock, Blocks.hotrock, Blocks.hotrock, Blocks.basalt, Blocks.basalt, Blocks.basalt},
    {Blocks.deepwater, Blocks.taintedWater, Blocks.sandWater, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt},
    {Blocks.deepwater, Blocks.taintedWater, Blocks.sandWater, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.moss, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt},
    {Blocks.deepwater, Blocks.sandWater, Blocks.darksand, Blocks.darksand, Blocks.moss, Blocks.moss, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt},
    {Blocks.taintedWater, Blocks.darksandTaintedWater, Blocks.darksand, Blocks.darksand, Blocks.basalt, Blocks.moss, Blocks.basalt, Blocks.hotrock, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt},
    {Blocks.darksandWater, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.moss, Blocks.sporeMoss, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt},
    {Blocks.darksandWater, Blocks.darksand, Blocks.darksand, Blocks.sporeMoss, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt},
    {Blocks.taintedWater, Blocks.darksandTaintedWater, Blocks.darksand, Blocks.sporeMoss, Blocks.sporeMoss, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt},
    {Blocks.darksandTaintedWater, Blocks.darksandTaintedWater, Blocks.darksand, Blocks.sporeMoss, Blocks.moss, Blocks.sporeMoss, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt},
    {Blocks.darksandWater, Blocks.darksand, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.basalt}
    };
    ...
    protected void generate(){
        ...
        Seq<Block> ores = Seq.with(Blocks.oreCopper, VanillaBlocks.oreLithium, VanillaBlocks.oreTungstene, Blocks.oreLead);
        ...
        pass((x, y) -> {
            ...
            if(floor == Blocks.hotrock){
                ...
                if(noise > 0.72f){
                    floor = noise > 0.78f ? Blocks.taintedWater : (floor == Blocks.darksand ? Blocks.sandWater : Blocks.darksandTaintedWater);
                    ore = Blocks.air;
                }else if(noise > 0.67f){
